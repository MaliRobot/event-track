# -*- coding: utf-8 -*-
"""
Created on Sat Sep 01 20:42:57 2018
...
def callEndpoint(endpoint, iterations):
   events = ['click', 'view', 'play']
   ...
   for i in range(iterations):
      ...
      r = requests.post(endpoint, json.dumps({'type': random_event, 'date': random_date, 'region': random_country}))
      print(random_event, random_date, random_country)
...
if __name__ == "__main__":
   if len(sys.argv) > 2:
      ...
      iterations = 10
   callEndpoint(endpoint, iterations)